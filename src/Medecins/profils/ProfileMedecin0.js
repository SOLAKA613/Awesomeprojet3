  ...
  render() {
    return (
      <View style={styles.Container}>
        ...
        <Image
          source={require('../../../../assets/Icons_Medecins/PCA3.jpg')}
          style={styles.circleImageLayout}
        />
        <View style={styles.text}>
          <View style={styles.text3}>
           <Text style={styles.text1}>Nom: </Text>
           <Text style={styles.text2}>Hadade </Text>
          </View>
          <View style={styles.text3}>
           <Text style={styles.text1}>Prénom: </Text>
           <Text style={styles.text2}>Hemed</Text>
          </View>
          <View style={styles.text3}>
           <Text style={styles.text1}>Date de naissance: </Text>
           <Text style={styles.text2}>12/01/1966</Text>
          </View>
          <View style={styles.text3}>
          ...
          <View style={styles.text3}>
           ...
           <Text style={styles.text2}>Tétouan</Text>
          </View>
          <View style={styles.text3}>
           <Text style={styles.text1}>Hopitale: </Text>
           <Text style={styles.text2}>Sania R'mel.</Text>
          </View>
          <View style={styles.text3}>
