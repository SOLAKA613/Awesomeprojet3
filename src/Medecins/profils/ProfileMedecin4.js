  ...
  render() {
    return (
      <View style={styles.Container}>
        ...
        <Image
          source={require('../../../../assets/Icons_Medecins/PCA10.jpg')}
          style={styles.circleImageLayout}
        />
        <View style={styles.text}>
          <View style={styles.text3}>
           <Text style={styles.text1}>Nom: </Text>
           <Text style={styles.text2}>Mika </Text>
          </View>
          <View style={styles.text3}>
           <Text style={styles.text1}>Prénom: </Text>
           <Text style={styles.text2}>Juliana</Text>
          </View>
          <View style={styles.text3}>
           <Text style={styles.text1}>Date de naissance: </Text>
           <Text style={styles.text2}>15/02/1987</Text>
          </View>
          <View style={styles.text3}>
           <Text style={styles.text1}>Pays: </Text>
           <Text style={styles.text2}>France</Text>
          </View>
          <View style={styles.text3}>
          ...
          <View style={styles.text3}>
           ...
           <Text style={styles.text2}>L’endocrinologie</Text>
          </View>
          <View style={styles.text3}>
